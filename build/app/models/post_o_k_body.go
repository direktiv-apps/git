...
type PostOKBody struct {
	...
	// git
	Git []*PostOKBodyGitItems `json:"git"`
}
...
func (m *PostOKBody) validateGit(formats strfmt.Registry) error {
...
func (m *PostOKBody) contextValidateGit(ctx context.Context, formats strfmt.Registry) error {
